...
const AddTransaction = (props) => {
  const getTanggal = () => {
    ...
    // bulan tambah 1 karena getMohth() mulai dari 0 untuk januari
  ...
  const handleFormSubmit = (e) => {
    ...
    if (formInput.tanggal.trim() === "") {
      ...
      pesanErrors.tanggal = "Format tanggal todak sesuai";
    } else {
      pesanErrors.tanggal = "";
    }
    ...
    // cek seluruh form valid atau masih ada error
        ...
        <form onSubmit={handleFormSubmit}>
          <div className="row">
            ...
            <div className="col-12 col-lg-2 mb-3 d-flex align-items-end">
                <button type="submit" className="btn-primary flex-fill">
                  Tambah
                </button>
            </div>
            <p>
